      ...
      <div className="container mx-auto h-full">
        <div className="flex content-center items-center justify-center h-full">
          <div className="w-full lg:w-6/12 px-4">
            <div className="relative flex flex-col min-w-0 break-words w-full mb-6 drop-shadow-lg rounded-xl bg-sky-50 border-0">
              <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                <div
                  className="text-blueGray-400 text-center mb-10 font-bold"
                  style={{ paddingTop: "20px" }}
                >
                  <h1
                    className="text-blueGray-600 text-xl" 
                ...
                <form>
                  <div className="relative w-full mb-12">
                    <label
                      className="block uppercase text-slate-600 text-xs font-bold mb-4"
                  ...
                  >
                    <button
                      className="bg-primary text-slate-100 active:bg-sky-300 bg-blue-400 text-sm font-bold uppercase px-6 py-3 rounded-xl shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                      type="button"
